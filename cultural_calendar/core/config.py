...
BARGEMUSIC_CACHE = ROOT / "bargemusic_capture" / "bargemusic-events.json"
JOYCE_CACHE = ROOT / "joyce_capture" / "joyce-performances.json"
MERKIN_CACHE = ROOT / "merkin_capture" / "merkin-events.json"
